  ...
  return (
    <div className="roleCard relative flex justify-between items-center border-l-2 border-[#ed194a] p-4 bg-[#ebebeb] min-w-xl w-full h-[100px] rounded-md text-black">
      ...
      <div className="left">
        ...
        <div className="roleTitle-Tags flex items-center space-x-3">
          ...
          <div className="flex flex-wrap">
            {["Solidity", "Hardhat", "Typescript"].map((item, idx) => (
              <Tag asset={item} id={idx} />
            ))}
          </div>
        </div>
      ...
      <div className="right">
        ...
        <button className="bg-transparent p-1 rounded-md text-[#ed194a] border border-[#ed194a] hover:bg-[#ed194a]">
          Show More
        </button>
      </div>
    </div>
