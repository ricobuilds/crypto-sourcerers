// everyone that has gotten a job through CryptoSourcerers
const Testimonials = () => {
  return (
    <div className="testimonials">
      <section id="socialProof" className="py-24 mx-auto hidden">
        {/* Testimonials */}
        ...
        <div className="flex flex-wrap m-0 w-full">
          <div className="p-4 md:w-1/2 w-full">
            <div className="h-full bg-white p-8 rounded border border-gray-200 dark:text-gray-800">
              <svg
          ...
          <div className="p-4 md:w-1/2 w-full">
            <div className="h-full bg-white backdrop-blur-lg p-8 rounded border border-gray-200 dark:text-gray-800">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                className="block w-5 h-5 text-gray-400 mb-4"
